/*
 * Copyright (C) 2025 Dmitriy Purgin <dpurgin@gmail.com>
...
void MetadataCacheTest::testDefaultMetadata()
{
    ...
    QCOMPARE(metadata.objectIdMapping()->dataType(), QMetaType{QMetaType::Int});
    ...
    QCOMPARE(mappings[0].dataType().id(), QMetaType::Int);
    ...
    QCOMPARE(mappings[1].dataType().id(), QMetaType::QString);
...

    {
        ...
        QCOMPARE(mapping->dataType().id(), QMetaType::Int);
...

    {
        ...
        QCOMPARE(mapping->dataType().id(), QMetaType::QString);
        QVERIFY(!mapping->isObjectId());
        QVERIFY(!mapping->isAutogenerated());
        QVERIFY(!mapping->isReference());
    }
...
void MetadataCacheTest::testOneToOneReference()
{
    ...
    QCOMPARE(provincePropertyMapping->dataType(), QMetaType::fromType<Town*>());
...
void MetadataCacheTest::testManyToOneReference()
{
    ...
    QCOMPARE(populationPropertyMapping->dataType(), QMetaType::fromType<QVector<Person*>>());
...
void MetadataCacheTest::testEnumColumn()
{
    ...
    QCOMPARE(myEnumMapping->dataType().id(), QMetaType::Int);
    ...
    QCOMPARE(myEnumClassMapping->dataType().id(), QMetaType::Int);
...
void MetadataCacheTest::testColumnWithNamespacedReference()
{
    ...
    QCOMPARE(myNamespacedClassMapping->dataType(),
             QMetaType::fromType<MyNamespace::WithNamespace*>());
